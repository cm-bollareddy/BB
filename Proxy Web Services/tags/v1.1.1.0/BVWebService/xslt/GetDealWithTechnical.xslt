...
<xsl:template match="/">
	...
	<diffgr:diffgram xmlns:msdata="urn:schemas-microsoft-com:xml-msdata" xmlns:diffgr="urn:schemas-microsoft-com:xml-diffgram-v1">
		<DealWithTechnicalDataSet xmlns="http://localhost/BVWebService/xsd/DealWithTechnicalDataSet.xsd">
			<xsl:for-each select="DATAPACKET/ROWDATA/ROW">
				...
				<xsl:for-each select="DEALVERSIONTYPE/ROWDEALVERSIONTYPE">
					<DEALVERSIONTYPE>
					<xsl:attribute name="diffgr:id">DEALVERSIONTYPE<xsl:value-of select="position()" /></xsl:attribute>
					<xsl:attribute name="msdata:rowOrder"><xsl:value-of select="position() - 1" /></xsl:attribute>
						<DVT_ID><xsl:value-of select="@DVT_ID" /></DVT_ID>
						<DVT_DEA_ID><xsl:value-of select="@DVT_DEA_ID" /></DVT_DEA_ID>
						<DVT_VET_ID><xsl:value-of select="@DVT_VET_ID" /></DVT_VET_ID>
					</DEALVERSIONTYPE>
				</xsl:for-each>
			</xsl:for-each>
		</DealWithTechnicalDataSet>
	</diffgr:diffgram>
	</DataSet>
</xsl:template>
</xsl:stylesheet>
