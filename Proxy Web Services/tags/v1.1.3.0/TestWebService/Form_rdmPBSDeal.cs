...
namespace TestWebService
{
	...
	public class Form_rdmPBSDeal : Form_Base
	{
		...
		private void InitializeComponent()
		{
            ...
            // btnCreateDeal
            // 
            this.btnCreateDeal.Location = new System.Drawing.Point(305, 193);
...
#region PUT DEAL APIs
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (m_sBVSessionId != null && m_sBVSessionId != string.Empty)
            {
                ...
                oDataSetResult = oBVWebService.ListProgramByDeal(m_sBVSessionId, int.Parse(txtSourceDealId.Text));
        ...
        private void btnCreateDeal_Click(object sender, EventArgs e)
        {
            ...
            if (m_sBVSessionId != null && m_sBVSessionId != string.Empty)
            {
                ...
                this.Log("CreateDeal - DealId: " +txtNewDealId.Text + " created successfully.");
                ClearForm();
        ...
        {
            txtNewDealId.Text = string.Empty;
            txtNewDealDesc.Text = string.Empty;
            txtMasterDealId.Text = string.Empty;
            txtMasterDealTitle.Text = string.Empty;
            chkSDRights.Checked = false;
            chkHDRights.Checked = false;
            txtEpisodeIds.Text = string.Empty;
            txtSourceDealId.Text = string.Empty;
            chkDealAttribute_ReUp.Checked = false;
            this.Refresh();
        }
