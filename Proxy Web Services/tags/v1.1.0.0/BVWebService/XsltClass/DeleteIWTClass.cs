...
namespace BVWebService
{
	...
	/// DeleteIWTClass .
	/// </summary>
	class DeleteIWTClass
	{
		
		public DeleteIWTClass()
		{
		}
		...
		public void DeleteIWT(string strSessionID,int nTabId,string strLockId)
		{
			...
			oTracer.LogInfo("Entering DeleteIWTClass.\n strSessionID=" + strSessionID + ", nTabId="  + nTabId);
			...
			catch (Exception ex)
			{
				throw new BVException(
					...
					"Component= TVSServer.rdmPBSManageTable DeleteIWT",
					ex);
			}
			...
			try
			{
				nErrorCode = oPBSManageTable.DeleteIWT(strSessionID, strLockId,nTabId, out strErrorText);
			}
			catch (Exception ex)
			{
				throw new BVException(
			...
			if (nErrorCode == 0)
			{
				oTracer.LogInfo("Leaving DeleteIWTClass.\n strSessionID=" + strSessionID + ", nTabId="  + nTabId);
