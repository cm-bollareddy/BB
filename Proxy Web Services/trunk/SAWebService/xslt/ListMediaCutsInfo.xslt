...
<xsl:template match="/">
	...
	<diffgr:diffgram xmlns:msdata="urn:schemas-microsoft-com:xml-msdata" xmlns:diffgr="urn:schemas-microsoft-com:xml-diffgram-v1">
		<MediaCutsInfoDataSet xmlns="http://localhost/SAWebService/ListMediaCutsInfoDataSet.xsd">
			<xsl:for-each select="DATAPACKET/ROWDATA/ROW">
				...
				<xsl:for-each select="ListMediaCutsInfo_DETAIL/ROWListMediaCutsInfo_DETAIL">
					<ListMediaCutsInfo_DETAIL>
					<xsl:attribute name="diffgr:id">ListMediaCutsInfo_DETAIL<xsl:value-of select="position()" /></xsl:attribute>
					<xsl:attribute name="msdata:rowOrder"><xsl:value-of select="position() - 1" /></xsl:attribute>
						<REVISIONHOUSENUMBER><xsl:value-of select="@REVISIONHOUSENUMBER" /></REVISIONHOUSENUMBER>
						...
						<xsl:if test="@ISVARIABLELENGTH != ''">
							<ISVARIABLELENGTH><xsl:value-of select="@ISVARIABLELENGTH" /></ISVARIABLELENGTH>
						</xsl:if>
						<xsl:if test="@AUDIOTYPE != ''">
							<AUDIOTYPE><xsl:value-of select="@AUDIOTYPE" /></AUDIOTYPE>
						</xsl:if>
