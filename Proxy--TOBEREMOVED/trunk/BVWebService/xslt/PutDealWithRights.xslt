	...
	<ROWDEALCONTENT>
		...
		<xsl:choose>
			<xsl:when test="$RowState = $ROWSTATE_AFTER">
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_ID) and DCO_ID) or (msxsl:node-set($Original)/DCO_ID != DCO_ID)">
					<xsl:attribute name="DCO_ID"><xsl:value-of select="DCO_ID" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_ID and not(DCO_ID)">
					<xsl:attribute name="DCO_ID"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_CHA_ID) and DCO_CHA_ID) or (msxsl:node-set($Original)/DCO_CHA_ID != DCO_CHA_ID)">
					<xsl:attribute name="DCO_CHA_ID"><xsl:value-of select="DCO_CHA_ID" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_CHA_ID and not(DCO_CHA_ID)">
					<xsl:attribute name="DCO_CHA_ID"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_TITLE) and DCO_TITLE) or (msxsl:node-set($Original)/DCO_TITLE != DCO_TITLE)">
					<xsl:attribute name="DCO_TITLE"><xsl:value-of select="DCO_TITLE" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_TITLE and not(DCO_TITLE)">
					<xsl:attribute name="DCO_TITLE"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_ARR_ID) and DCO_ARR_ID) or (msxsl:node-set($Original)/DCO_ARR_ID != DCO_ARR_ID)">
					<xsl:attribute name="DCO_ARR_ID"><xsl:value-of select="DCO_ARR_ID" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_ARR_ID and not(DCO_ARR_ID)">
					<xsl:attribute name="DCO_ARR_ID"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_DAYSAVAILABLE) and DCO_DAYSAVAILABLE) or (msxsl:node-set($Original)/DCO_DAYSAVAILABLE != DCO_DAYSAVAILABLE)">
					<xsl:attribute name="DCO_DAYSAVAILABLE"><xsl:value-of select="DCO_DAYSAVAILABLE" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_DAYSAVAILABLE and not(DCO_DAYSAVAILABLE)">
					<xsl:attribute name="DCO_DAYSAVAILABLE"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_DATEAVAILABLEFROM) and DCO_DATEAVAILABLEFROM) or (msxsl:node-set($Original)/DCO_DATEAVAILABLEFROM != DCO_DATEAVAILABLEFROM)">
					<xsl:attribute name="DCO_DATEAVAILABLEFROM"><xsl:value-of select="DCO_DATEAVAILABLEFROM" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_DATEAVAILABLEFROM and not(DCO_DATEAVAILABLEFROM)">
					<xsl:attribute name="DCO_DATEAVAILABLEFROM"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_DATEAVAILABLETO) and DCO_DATEAVAILABLETO) or (msxsl:node-set($Original)/DCO_DATEAVAILABLETO != DCO_DATEAVAILABLETO)">
					<xsl:attribute name="DCO_DATEAVAILABLETO"><xsl:value-of select="DCO_DATEAVAILABLETO" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_DATEAVAILABLETO and not(DCO_DATEAVAILABLETO)">
					<xsl:attribute name="DCO_DATEAVAILABLETO"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_ISOBBASED) and DCO_ISOBBASED) or (msxsl:node-set($Original)/DCO_ISOBBASED != DCO_ISOBBASED)">
					<xsl:attribute name="DCO_ISOBBASED"><xsl:value-of select="DCO_ISOBBASED" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_ISOBBASED and not(DCO_ISOBBASED)">
					<xsl:attribute name="DCO_ISOBBASED"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_ISEXCLUSIVE) and DCO_ISEXCLUSIVE) or (msxsl:node-set($Original)/DCO_ISEXCLUSIVE != DCO_ISEXCLUSIVE)">
					<xsl:attribute name="DCO_ISEXCLUSIVE"><xsl:value-of select="DCO_ISEXCLUSIVE" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_ISEXCLUSIVE and not(DCO_ISEXCLUSIVE)">
					<xsl:attribute name="DCO_ISEXCLUSIVE"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_BLACKOUTFROM) and DCO_BLACKOUTFROM) or (msxsl:node-set($Original)/DCO_BLACKOUTFROM != DCO_BLACKOUTFROM)">
					<xsl:attribute name="DCO_BLACKOUTFROM"><xsl:value-of select="DCO_BLACKOUTFROM" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_BLACKOUTFROM and not(DCO_BLACKOUTFROM)">
					<xsl:attribute name="DCO_BLACKOUTFROM"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_BLACKOUTTO) and DCO_BLACKOUTTO) or (msxsl:node-set($Original)/DCO_BLACKOUTTO != DCO_BLACKOUTTO)">
					<xsl:attribute name="DCO_BLACKOUTTO"><xsl:value-of select="DCO_BLACKOUTTO" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_BLACKOUTTO and not(DCO_BLACKOUTTO)">
					<xsl:attribute name="DCO_BLACKOUTTO"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_BLACKOUTFROM2) and DCO_BLACKOUTFROM2) or (msxsl:node-set($Original)/DCO_BLACKOUTFROM2 != DCO_BLACKOUTFROM2)">
					<xsl:attribute name="DCO_BLACKOUTFROM2"><xsl:value-of select="DCO_BLACKOUTFROM2" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_BLACKOUTFROM2 and not(DCO_BLACKOUTFROM2)">
					<xsl:attribute name="DCO_BLACKOUTFROM2"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_BLACKOUTTO2) and DCO_BLACKOUTTO2) or (msxsl:node-set($Original)/DCO_BLACKOUTTO2 != DCO_BLACKOUTTO2)">
					<xsl:attribute name="DCO_BLACKOUTTO2"><xsl:value-of select="DCO_BLACKOUTTO2" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_BLACKOUTTO2 and not(DCO_BLACKOUTTO2)">
					<xsl:attribute name="DCO_BLACKOUTTO2"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_BLACKOUTFROM3) and DCO_BLACKOUTFROM3) or (msxsl:node-set($Original)/DCO_BLACKOUTFROM3 != DCO_BLACKOUTFROM3)">
					<xsl:attribute name="DCO_BLACKOUTFROM3"><xsl:value-of select="DCO_BLACKOUTFROM3" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_BLACKOUTFROM3 and not(DCO_BLACKOUTFROM3)">
					<xsl:attribute name="DCO_BLACKOUTFROM3"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_BLACKOUTTO3) and DCO_BLACKOUTTO3) or (msxsl:node-set($Original)/DCO_BLACKOUTTO3 != DCO_BLACKOUTTO3)">
					<xsl:attribute name="DCO_BLACKOUTTO3"><xsl:value-of select="DCO_BLACKOUTTO3" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_BLACKOUTTO3 and not(DCO_BLACKOUTTO3)">
					<xsl:attribute name="DCO_BLACKOUTTO3"></xsl:attribute>
				</xsl:if>
				<xsl:if test="(not(msxsl:node-set($Original)/DCO_DEA_ID) and DCO_DEA_ID) or (msxsl:node-set($Original)/DCO_DEA_ID != DCO_DEA_ID)">
					<xsl:attribute name="DCO_DEA_ID"><xsl:value-of select="DCO_DEA_ID" /></xsl:attribute>
				</xsl:if>
				<xsl:if test="msxsl:node-set($Original)/DCO_DEA_ID and not(DCO_DEA_ID)">
					<xsl:attribute name="DCO_DEA_ID"></xsl:attribute>
				</xsl:if>
			</xsl:when>
			<xsl:otherwise>
				<xsl:attribute name="DCO_ID"><xsl:value-of select="DCO_ID" /></xsl:attribute>
	...
	<ROW>
		...
		<DEALCONTENT>
			<xsl:if test="($RowState=$ROWSTATE_NEW) or ($RowState=$ROWSTATE_BEFORE) or ($RowState=$ROWSTATE_UNCHANGED)">
				<xsl:for-each select="//DealWithRightsDataSet/DEALCONTENT">
					<xsl:choose>
						<xsl:when test="@diffgr:hasChanges='inserted'">
							<xsl:call-template name="OutputDEALCONTENT">
								<xsl:with-param name="RowState" select="$ROWSTATE_NEW" />
							</xsl:call-template>
						</xsl:when>

						<xsl:when test="@diffgr:hasChanges='modified'">
							<xsl:for-each select="key('OriginalDEALCONTENT', @diffgr:id)">
								<xsl:call-template name="OutputDEALCONTENT">
									<xsl:with-param name="RowState" select="$ROWSTATE_BEFORE" />
								</xsl:call-template>
							</xsl:for-each>
							<xsl:call-template name="OutputDEALCONTENT">
								<xsl:with-param name="Original" select="key('OriginalDEALCONTENT', @diffgr:id)" />
								<xsl:with-param name="RowState" select="$ROWSTATE_AFTER" />
							</xsl:call-template>
						</xsl:when>
					</xsl:choose>
				</xsl:for-each>
				<xsl:for-each select="//diffgr:before/DEALCONTENT">
					<xsl:if test="count(key('CurrentDEALCONTENT', @diffgr:id)) = 0">
						<xsl:call-template name="OutputDEALCONTENT">
...
<xsl:template match="/">
	...
	<ROWDATA>
		<xsl:for-each select="//DealWithRightsDataSet/DEAL">
			<xsl:choose>
				<xsl:when test="@diffgr:hasChanges='inserted'">
