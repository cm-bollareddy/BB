...
{
	/// <summary>
	/// ListPackageMediaInfoClass: Implement the ListPackageMediaInfo web method.
	/// </summary>
	class ListPackageMediaInfoClass
	{
		private const string FILE_SEARCH_XSLT = @"ListPackageMediaInfo.xslt";

		public ListPackageMediaInfoClass()
		{
			//
		...
		public DataSet ListPackageMediaInfo(string strSessionID, SearchCriterion[] searchCriteria, int nMaxRows)
		{
			//
			...
			oTracer.LogInfo("Entering ListPackageMediaInfo.\n searchParams=" + searchParams);
			...
			catch (Exception ex)
			{
				throw new BVException(
					...
					"Component= TVSServer.rdmPBSSearch ListPackageMediaInfo \nCriteria(" + searchParams + ")",
					ex);
			}
			...
			try
			{
				nErrorCode = oPBSSearch.ListPackageMediaInfo(strSessionID, oSearchParams, nMaxRows, out strSearchResult, out strErrorText);
			}
			catch (Exception ex)
			{
				throw new BVException(
