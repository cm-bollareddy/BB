...
{
	/// <summary>
	/// ListMediaCutsInfoClass: Implement the ListMediaCutsInfo web method.
	/// </summary>
	class ListMediaCutsInfoClass
	{
		private const string FILE_SEARCH_XSLT = @"ListMediaCutsInfo.xslt";

		public ListMediaCutsInfoClass()
		{
			//
		...
		public DataSet ListMediaCutsInfo(string strSessionID, SearchCriterion[] searchCriteria, int nMaxRows)
		{
			//
			...
			oTracer.LogInfo("Entering ListMediaCutsInfo.\n searchParams=" + searchParams);
			...
			catch (Exception ex)
			{
				throw new BVException(
					...
					"Component= TVSServer.rdmPBSSearch ListMediaCutsInfo \nCriteria(" + searchParams + ")",
					ex);
			}
			...
			try
			{
				nErrorCode = oPBSSearch.ListMediaCutsInfo(strSessionID, oSearchParams, nMaxRows, out strSearchResult, out strErrorText);
			}
			catch (Exception ex)
			{
				throw new BVException(
